    ...
    <div class="h-screen w-screen flex items-center justify-center">
        <div class="w-screen">
            <div class="max-w-sm mx-auto">
                <div class="relative -mb-px h-px w-full bg-linear-to-r from-transparent via-sky-300 to-transparent"></div>
                <div class="mb-5">
                ...
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-hidden focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center" onclick={login}>Submit</button>
            </div>
        </div>
    </div>