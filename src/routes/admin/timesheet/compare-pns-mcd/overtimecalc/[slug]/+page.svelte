...
<div class="table-container flex flex-col">
    ...
    <div class="flex w-full justify-between p-4">
        <button class="bg-blue-500 p-4 rounded-md text-white" onclick={recalculate}>Recalculate</button>
        <button class="bg-green-500 p-4 rounded-md text-white" onclick={()=> {alertVerify=true}}>verify</button>
    </div>
